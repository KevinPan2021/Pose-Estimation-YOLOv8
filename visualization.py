...
def plot_training_curves(train_bbox_mAP, train_kpt_mAP, train_loss, valid_bbox_mAP, valid_kpt_mAP, valid_loss):
    plt.figure()
    ...
    plt.figure()
    plt.plot(train_bbox_mAP, label='train')
    plt.plot(valid_bbox_mAP, label='valid')
    plt.title('bbox mAP curves')
    plt.xlabel('epochs')
